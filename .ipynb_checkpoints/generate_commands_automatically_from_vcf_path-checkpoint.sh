...
echo
echo -e "Debug Example:  bash generate_commands_from_vcf_path.sh /mnt/stsi/stsi0/raqueld/vcf/SHARE_MESA_c2_flipfix.vcf /mnt/stsi/stsi0/raqueld HRC 0 1 > MESA_jobs_c1_0-1.txt"
echo -e "Debug Example:  bash generate_commands_from_vcf_path.sh /mnt/stsi/stsi0/raqueld/vcf/SHARE_MESA_c2_flipfix.vcf /mnt/stsi/stsi0/raqueld HRC 2 6 > MESA_jobs_c1_2-6.txt"
echo 
...
job1='qsub 1_lift_vcfs_to_GRCh37.job -v myinput=${myinput},buildcheck=${outroot}/0_check_vcf_build/${prefix}.BuildChecked,myoutdir=${outroot}/1_lift,copyoutput=no,custom_temp=${temp} -N 1_${prefix}'
